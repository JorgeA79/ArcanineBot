...
client.on('guildMemberAdd', member => {
    member.guild.channels.get('399340623314026498').send('Hello! **' + member.user.toString + '**, Welcome To RoaringArcanine I hope that you will enjoy your stay here and have fun! \nPlease make sure to read the rules'); 
});
